...
Hangman is a classic word game in which the player has to guess the secret word one letter at a time.
...
This is to install the required dependencies into the project's folder.
